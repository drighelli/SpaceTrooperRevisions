...
out_dir <- "~/SpaceTrooper_qs_check1/ablation"
...
saveRDS(abl_cosmx, file.path(out_dir, "cosmx_qs_ablation_results.rds"))
## ============================================================
...
p_no_signal_col <- plot_ablation_colored(
    ...
    output_file=file.path(out_dir, "cosmx_full_vs_no_log2SignalDensity_log2Ctrl_total_ratiocolored.pdf")
)
p_no_signal_col_area <- plot_ablation_colored(
    ...
    title="CosMx: full QS vs QS without log2SignalDensity",
    y_label="QS without log2SignalDensity",
    output_file=file.path(out_dir, "cosmx_full_vs_no_log2SignalDensity_Area_um_colored.pdf")
)
...
p_no_signal_col_aspect <- plot_ablation_colored(
    ...
    title="CosMx: full QS vs QS without log2SignalDensity",
    y_label="QS without log2SignalDensity",
    output_file=file.path(out_dir, "cosmx_full_vs_no_log2SignalDensity_log2AspectRatio_colored.pdf")
)
...
plot_ablation_colored(
    ...
    output_file=file.path(out_dir, "cosmx_full_vs_no_log2ctrl_total_ratio_log2SignalDensitycolored.pdf")
)$plot
...
plot_ablation_colored(
    ...
    title="CosMx: full QS vs QS without log2Ctrl_total_ratio",
    y_label="QS without log2Ctrl_total_ratio",
    output_file=file.path(out_dir, "cosmx_full_vs_no_log2Ctrl_total_ratio_Area_um_colored.pdf")
)$plot
plot_ablation_colored(
    ablation_results=abl_cosmx,
    ablation_name="no_log2Ctrl_total_ratio",
    ...
    title="CosMx: full QS vs QS without log2Ctrl_total_ratio",
    y_label="QS without log2Ctrl_total_ratio",
    output_file=file.path(out_dir, "cosmx_full_vs_no_log2Ctrl_total_ratio_log2AspectRatio_colored.pdf")
)$plot
